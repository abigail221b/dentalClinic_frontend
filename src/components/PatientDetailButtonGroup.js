...
function PatientDetailButtonGroup({ patient, setPatient }) {
    ...
    const { isOpen: updateFormIsOpen, onOpen: updateFormOnOpen, onClose: updateFormOnClose } = useDisclosure();
    ...
    return (
        <ButtonGroup>
            ...
            <Button onClick={updateFormOnOpen}>Edit Patient</Button>
                <UpdatePatientForm isOpen={updateFormIsOpen} onClose={updateFormOnClose} patient={patient} setPatient={setPatient} />
